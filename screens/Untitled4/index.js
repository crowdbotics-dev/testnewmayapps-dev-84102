...
const Untitled4 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><ImageBackground style={styles.arkNTrUF} source={{
      ...
      }} resizeMode="cover"></ImageBackground><TextInput style={styles.WbmoZBiR}></TextInput><ActivityIndicator style={styles.TtgrUjhL}></ActivityIndicator><Slider style={styles.MPxwksYP} thumbStyle={{
        height: 20,
        width: 20
      }} thumbTintColor="#0000FF" maximumValue={1} minimumValue={0}></Slider><Slider style={styles.cBIiZArD} thumbStyle={{
        height: 20,
        width: 20
      }} thumbTintColor="#0000FF" maximumValue={1} minimumValue={0}></Slider><Text style={styles.dPbzcobw}>Lorem ipsum…</Text><View style={styles.bhKlgXSX}></View></ScrollView>
    </SafeAreaView>;
};
