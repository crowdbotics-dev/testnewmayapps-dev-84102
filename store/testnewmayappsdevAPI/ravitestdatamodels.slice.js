...
export const api_v1_ravitestdatamodel_list = createAsyncThunk("ravitestdatamodels/api_v1_ravitestdatamodel_list", async payload => {
  const response = await apiService.api_v1_ravitestdatamodel_list(payload);
  return response.data;
});
export const api_v1_ravitestdatamodel_create = createAsyncThunk("ravitestdatamodels/api_v1_ravitestdatamodel_create", async payload => {
  const response = await apiService.api_v1_ravitestdatamodel_create(payload);
  return response.data;
});
export const api_v1_ravitestdatamodel_retrieve = createAsyncThunk("ravitestdatamodels/api_v1_ravitestdatamodel_retrieve", async payload => {
  const response = await apiService.api_v1_ravitestdatamodel_retrieve(payload);
  return response.data;
});
export const api_v1_ravitestdatamodel_update = createAsyncThunk("ravitestdatamodels/api_v1_ravitestdatamodel_update", async payload => {
  const response = await apiService.api_v1_ravitestdatamodel_update(payload);
  return response.data;
});
export const api_v1_ravitestdatamodel_partial_update = createAsyncThunk("ravitestdatamodels/api_v1_ravitestdatamodel_partial_update", async payload => {
  const response = await apiService.api_v1_ravitestdatamodel_partial_update(payload);
  return response.data;
});
export const api_v1_ravitestdatamodel_destroy = createAsyncThunk("ravitestdatamodels/api_v1_ravitestdatamodel_destroy", async payload => {
